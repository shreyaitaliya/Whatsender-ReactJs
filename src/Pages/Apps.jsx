...
import { AppsData } from '../Utils/Util';
        ...
        <div>
                    ...
                    <div className='d-flex justify-content-between align-items-center justify-content-center'>
                        <div className='col-4 fs-6' style={{ color: '#5e72e4' }}>
                            <div>
                                ...
                                <a href="#" className='mx-1' style={{ textDecoration: 'none' }}>Apps</a> -
                ...
                <div className='d-flex justify-content-between align-items-center'>
                    <div className='col-4 p-2 ps-0'>
                        <div style={{ backgroundColor: 'white', padding: '15px' }}>
                            ...
                            <p className='fs-6 mt-2 mb-0' style={{ color: '#8898aa' }}>Total Apps</p>
                        </div>
                    </div>
                    <div className='col-4 p-2'>
                        <div style={{ backgroundColor: 'white', padding: '15px' }}>
                            ...
                            <p className='fs-6 mt-2 mb-0' style={{ color: '#8898aa' }}>Active Apps</p>
                        </div>
                    </div>
                    <div className='col-4 p-2'>
                        <div style={{ backgroundColor: 'white', padding: '15px' }}>
                            ...
                            <p className='fs-6 mt-2 mb-0' style={{ color: '#8898aa' }}>Inactive Apps</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container mt-4">
                ...
                <table className="table">
                    <thead>
                        <tr>
                            <th style={{ backgroundColor: 'transparent', color: '#212529' }}>Apps Name</th>
                            <th style={{ backgroundColor: 'transparent', color: '#212529' }}>User</th>
                            <th style={{ backgroundColor: 'transparent', color: '#212529' }}>Website</th>
                    ...
                    <tbody style={{ fontSize: '14px', color: '#212529' }}>
                        {AppsData.map((apps) => (
                            <tr key={apps.id}>
                                <td style={{ padding: '16px' }}>{apps.appName}</td>
                                <td style={{ padding: '16px' }}>{apps.user}</td>
                                <td style={{ padding: '16px' }}>
                                    <span className="badge bg-danger">{apps.website}</span>
                                </td>
                                <td style={{ padding: '16px' }}>{apps.transactions.toFixed(2)}</td>
                                <td style={{ padding: '16px' }}>
                                    <span className="badge bg-success">{apps.status}</span>
                                </td>
                                <td style={{ padding: '16px' }}>{apps.createdAt}</td>
                                <td style={{ padding: '16px' }}>
